...
from utils import ( public_key_to_keccak256, )
...
class Transaction:
    ...
    def __init__(self, account, web3):
        self.account = account
        self.w3 = web3

    @staticmethod
    def build_transaction(type,
                          gas,gasPrice,
                          nonce,
                          from_,
                          to,
    ...
    def send_transaction(self, transaction):
        ...
        gas = self.w3.eth.estimateGas(transaction)
        transaction['gas'] = gas
        signed_tx = self.w3.eth.account.sign_transaction(transaction, self.account.privateKey)
